...
//             ):(
//               <p className='text-sm text-gray-600'> Create an account<sapn onClick={()=>{setCurrState("Sign up")}}className='font-medium text-violet-500 cursor-pointer' >Click here</sapn> </p>
//             )}
//           </div>
//       </form>
//       </div>
...
const Loginpage = () => {
  ...
  const { authenticate, authUser } = useContext(AuthContext);
